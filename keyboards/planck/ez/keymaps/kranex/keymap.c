...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
      ...
      ,KC_LCTRL,KC_LGUI,KC_NO,KC_LALT,LOWER,KC_SPACE,KC_NO,RAISE,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT),
  ...
  [_ADJUST] = LAYOUT_planck_grid(KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
      KC_DELETE,KC_TRANSPARENT,KC_TRANSPARENT,CLICKY_TOGGLE,AU_TOG,KC_TRANSPARENT,TOGGLE_LAYER_COLOR,RGB_TOG,RGB_VAI,RGB_VAD,KC_TRANSPARENT,RESET,
      KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LED_LEVEL,MU_TOG,MU_MOD,RGB_SLD,RGB_MOD,RGB_HUI,RGB_HUD,KC_TRANSPARENT,KC_TRANSPARENT,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [2] = {
      COLOR_1, COLOR_0, COLOR_1, COLOR_0, COLOR_1, COLOR_0, COLOR_1, COLOR_0, COLOR_1, COLOR_0, COLOR_1, COLOR_0,
      COLOR_1, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_1,
      COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0,
    ...
    [3] = {
      COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_0,
      COLOR_1, COLOR_0, COLOR_0, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_0, COLOR_1,
      COLOR_0, COLOR_0, COLOR_0, COLOR_0, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_1, COLOR_0, COLOR_0,
